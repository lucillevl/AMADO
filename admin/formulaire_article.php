...
<main class="width-80 marg-auto">
    <h1 class="center-align marron-text engras">Ajouter un article</h1>
    <?= $msg?>
    <form action="ajout_article.php" method="post" enctype="multipart/form-data"  class="flex-col flex-c-c">
        <div class="input-field width-100">
            <label for="titre_article">Titre</label>
            <input type="text" id="titre_article" name="titre" value="<?= !empty($titre) ? $titre : '' ?>">
        </div>
        <div class="input-field width-100">
            <label for="auteur">Auteur</label>
            <input type="text" id="auteur" name="auteur" <?= !empty($auteur) ? $auteur : '' ?>>
        </div>
        <div class="input-field width-100">
            <label for="contenu_article">Contenu de l'article</label>
            <textarea id="contenu_article" name="contenu" class="materialize-textarea"><?= !empty($contenu) ? $contenu : '' ?></textarea>
        </div>
        <div class="file-field input-field width-100">
            ...
            <div class="file-path-wrapper">
                <input class="file-path validate" type="text"  name="photo_principale" placeholder="Photo principale de l'article" value="<?= !empty($photo_principale) ? $photo_principale : '' ?>">
            </div>
        </div>
        ...
        <div class="file-field input-field width-100">
            ...
            <div class="file-path-wrapper">
                <input class="file-path validate" type="text"  name="autre_photo" placeholder="Ajouter d'autres photos à l'article" value="<?= !empty($autre_photo) ? $autre_photo : '' ?>">
            </div>
        </div>
